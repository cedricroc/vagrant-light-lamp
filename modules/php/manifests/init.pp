class php {
    ...
    $phpPackages = ["php5", "php5-cli", "php5-mysql", "php-pear", "php5-dev", "php-apc", "php5-mcrypt", "php5-gd", "php5-sqlite", "php5-curl", "php5-intl", "php5-xdebug", "php5-imagick", "libapache2-mod-php5"]
    package { $phpPackages:
        ensure => latest,
